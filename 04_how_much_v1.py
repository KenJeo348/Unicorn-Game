...
check that the input is a valid integer between 1 and 10.
If it is, this amount becomes the balance in their account."""
...
print(f"You are playing with ${user_balance} dollars. ")
